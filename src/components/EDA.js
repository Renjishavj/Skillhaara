...
//     <div>
//       <div>
//         <img src={ban} alt="Banner" style={{ width: "100%", height: "auto" }} />
//       </div>
//       <div>
...
//         <p className="eda-desc">{courseDetails.technologiesDesc}</p>
//         <ul className="eda-ul" style={{ listStyle: 'disc' }}>
//             {courseDetails.courses.map((course, index) => (
//               <li key={index}>{course}</li>  // Assuming courses is an array in courseDetails
//             ))}
//           </ul>
//       </div>
